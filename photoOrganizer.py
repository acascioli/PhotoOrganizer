...
localPath = plib.Path(plib.Path(__file__).parents[0])
# localPath = plib.Path(plib.Path(__file__).parents[0], 'Test_1')
destinationPath = plib.Path(plib.Path(__file__).parents[0], 'Sorted')
